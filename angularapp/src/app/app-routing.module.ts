...
const routes: Routes = [
  ...
  { path: 'userhome', component: UserhomeComponent, canActivate: [AuthGuard], data: { role: 'User' } },
  ...
  { path: 'adminlog', component: AdminLogComponent, canActivate: [AuthGuard], data: { role: 'Admin' } },
